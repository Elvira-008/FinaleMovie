...
model_path = os.path.join(settings.BASE_DIR, 'model_movi.pkl')
model = joblib.load(model_path)

vec_path = os.path.join(settings.BASE_DIR, 'vec_movi.pkl')
...
class RatingSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        model = Rating
        fields = ['id','user', 'parent','movie', 'stars', 'text', 'created_date', 'check_comments']

    def get_check_comments(self, obj):
        return model.predict(vec.transform([obj.text]))
