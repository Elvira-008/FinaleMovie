# Generated by Django 5.2.7 on 2025-10-12 06:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(12), django.core.validators.MaxValueValidator(70)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie_name_tr', models.CharField(max_length=64, null=True)),
                ...
                ('status_movie', models.CharField(choices=[('pro', 'pro'), ('simple', 'simple')], max_length=20)),
                ('actor', models.ManyToManyField(to='moview.actor')),
                ('country', models.ManyToManyField(to='moview.country')),
                ('director', models.ManyToManyField(to='moview.director')),
                ('genre', models.ManyToManyField(to='moview.genre')),
            ],
        ),
        migrations.CreateModel(
            name='Moments',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='moview.favorite')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='moview.movie')),
            ],
        ),
        migrations.CreateModel(
